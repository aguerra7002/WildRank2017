...
//            ((TextView) findViewById(R.id.scales)).setText("Scales: " + formatNumberAsString(scales));
    ...
    private String getString(int index) {
        switch (index) {
            case 0:
                return StrongholdConstants.LOW_BAR;
            case 1:
                return StrongholdConstants.PORTCULLIS;
            case 2:
                return StrongholdConstants.QUAD_RAMP;
            case 3:
                return StrongholdConstants.RAMPARTS;
            case 4:
                return StrongholdConstants.MOAT;
            case 5:
                return StrongholdConstants.DRAWBRIDGE;
            case 6:
                return StrongholdConstants.SALLYPORT;
            case 7:
                return StrongholdConstants.ROCK_WALL;
            case 8:
                return StrongholdConstants.ROUGH_TERRAIN;
            default:
                return "***Wildstang***";
        }
    }
